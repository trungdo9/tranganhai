...
**Activate the `planning` skill** ([.agents/skills/software/planning/SKILL.md](.agents/skills/software/planning/SKILL.md)) and follow its methodology in full:
...
- **Respect** `./.agents/workflows/development-rules.md`.
