...
4. **Validate** — pass quality gates from `.agents/workflows/marketing-rules.md` (copy quality, E-E-A-T, CRO, brand voice).
...
- `.agents/workflows/automation-rules.md` — automation rules (MCP, idempotency, PII)
