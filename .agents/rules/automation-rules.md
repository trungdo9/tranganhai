...
| MCP | Manual fallback |
|---|---|
| GA4 | User exports CSV → view_file tool → analyze |
| GSC | User exports CSV → view_file tool → analyze |
...
- `.agents/workflows/marketing-workflow.md` — 10-phase marketing pipeline
- `.agents/workflows/sales-workflow.md` — 5-phase lead→customer
- `.agents/workflows/crm-workflow.md` — 5-phase lifecycle
- `.agents/workflows/video-workflow.md` — 6-phase video production
