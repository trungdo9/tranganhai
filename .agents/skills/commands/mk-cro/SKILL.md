---
name: mk-cro
description: Conversion Rate Optimization — audit, landing pages, signup, email Trigger by asking for /mk:cro or /mk-cro.
---
...
Activate `copywriting` + `cro` skills. Reference .agents/workflows/cro-framework.md (25 points).

### Actions

- **`audit`** — Full CRO audit using 25-point framework (see .agents/workflows/cro-framework.md)
  - skills: `cro`
