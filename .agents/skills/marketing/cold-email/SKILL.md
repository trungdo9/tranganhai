---
name: cold-email
description: Cold email outreach — subject lines, personalization, sequences, deliverability.
allowed-tools: Read, Write, Glob, Grep
---

# Cold Email

> Cold email outreach — subject lines, personalization, sequences, deliverability.
...
- `plans/marketing/<campaign>/cold-email.md` — analysis / audit / brief
