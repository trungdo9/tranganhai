...
description: "Competitors vs [us]" comparison pages — positioning, copy patterns, schema.
allowed-tools: Read, Write, Glob, Grep
---

# Competitor Alternatives

> "Competitors vs [us]" comparison pages — positioning, copy patterns, schema.
...
- `plans/marketing/<campaign>/competitor-alternatives.md` — analysis / audit / brief
