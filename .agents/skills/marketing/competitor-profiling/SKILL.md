...
description: Deep competitor analysis — positioning, pricing, channels, weaknesses.
allowed-tools: Read, Write, Glob, Grep
---

# Competitor Profiling

> Deep competitor analysis — positioning, pricing, channels, weaknesses.
...
- `plans/marketing/<campaign>/competitor-profiling.md` — analysis / audit / brief
