...
description: Content strategy — pillars, calendar, distribution, repurposing.
allowed-tools: Read, Write, Glob, Grep
---

# Content Strategy

> Content strategy — pillars, calendar, distribution, repurposing.
...
- `plans/marketing/<campaign>/content-strategy.md` — analysis / audit / brief
