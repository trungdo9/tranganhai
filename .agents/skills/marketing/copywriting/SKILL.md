---
name: copywriting
description: Copywriting — headlines, value props, CTAs, conversion-oriented writing.
allowed-tools: Read, Write, Glob, Grep
---

# Copywriting

> Copywriting — headlines, value props, CTAs, conversion-oriented writing.
...
- `plans/marketing/<campaign>/copywriting.md` — analysis / audit / brief
