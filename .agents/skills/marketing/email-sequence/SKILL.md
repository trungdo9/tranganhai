---
name: email-sequence
description: Email sequences — welcome, nurture, re-engagement, onboarding drips.
allowed-tools: Read, Write, Glob, Grep
---

# Email Sequence

> Email sequences — welcome, nurture, re-engagement, onboarding drips.
...
- `plans/marketing/<campaign>/email-sequence.md` — analysis / audit / brief
