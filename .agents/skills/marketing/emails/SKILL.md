---
name: emails
description: Email marketing — campaign strategy, segmentation, deliverability, A/B testing.
allowed-tools: Read, Write, Glob, Grep
---

# Emails

> Email marketing — campaign strategy, segmentation, deliverability, A/B testing.
...
- `plans/marketing/<campaign>/emails.md` — analysis / audit / brief
