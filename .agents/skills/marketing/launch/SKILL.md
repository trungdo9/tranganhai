---
name: launch
description: Product launch — pre-launch, launch day, post-launch playbook. PH launches, Product Hunt.
allowed-tools: Read, Write, Glob, Grep
---

# Launch

> Product launch — pre-launch, launch day, post-launch playbook. PH launches, Product Hunt.
...
- `plans/marketing/<campaign>/launch.md` — analysis / audit / brief
