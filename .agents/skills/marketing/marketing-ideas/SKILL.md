...
description: Marketing ideas library — tactics, channels, growth experiments, case studies.
allowed-tools: Read, Write, Glob, Grep
---

# Marketing Ideas

> Marketing ideas library — tactics, channels, growth experiments, case studies.
...
- `plans/marketing/<campaign>/marketing-ideas.md` — analysis / audit / brief
