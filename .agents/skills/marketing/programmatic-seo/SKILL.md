...
description: Programmatic SEO — template pages, data sources, internal linking at scale.
allowed-tools: Read, Write, Glob, Grep
---

# Programmatic Seo

> Programmatic SEO — template pages, data sources, internal linking at scale.
...
**Explicit:** "Use the programmatic-seo skill to [task]."
...
- `plans/marketing/<campaign>/programmatic-seo.md` — analysis / audit / brief
