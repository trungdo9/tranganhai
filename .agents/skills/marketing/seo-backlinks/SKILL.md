---
name: seo-backlinks
description: Backlink analysis — quality scoring, anchor text distribution, outreach targets.
allowed-tools: Read, Write, Glob, Grep
---

# Seo Backlinks

> Backlink analysis — quality scoring, anchor text distribution, outreach targets.
...
- `plans/marketing/<campaign>/seo-backlinks.md` — analysis / audit / brief
