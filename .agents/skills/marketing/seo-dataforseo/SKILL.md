---
name: seo-dataforseo
description: DataForSEO API integration — SERP data, keyword volume, backlink database.
allowed-tools: Read, Write, Glob, Grep
---

# Seo Dataforseo

> DataForSEO API integration — SERP data, keyword volume, backlink database.
...
- `plans/marketing/<campaign>/seo-dataforseo.md` — analysis / audit / brief
