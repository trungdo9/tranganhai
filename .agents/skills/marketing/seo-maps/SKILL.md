---
name: seo-maps
description: Google Maps / map-pack SEO — local citations, reviews, geo-signals.
allowed-tools: Read, Write, Glob, Grep
---

# Seo Maps

> Google Maps / map-pack SEO — local citations, reviews, geo-signals.
...
- `plans/marketing/<campaign>/seo-maps.md` — analysis / audit / brief
