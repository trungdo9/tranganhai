---
name: sms
description: SMS marketing — compliance, cadence, segmentation, opt-in flows.
allowed-tools: Read, Write, Glob, Grep
---

# Sms

> SMS marketing — compliance, cadence, segmentation, opt-in flows.
...
- `plans/marketing/<campaign>/sms.md` — analysis / audit / brief
