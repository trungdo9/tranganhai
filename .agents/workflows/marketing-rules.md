...
Default: load `.agents/workflows/cro-framework.md` (25-point Conversion Optimization Framework). Use the 25-point checklist when optimizing landing pages, signup flows, or email CTAs.
...
- `.agents/workflows/cro-framework.md` — CRO 25-point framework
