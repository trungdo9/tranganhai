---
name: mk-nurture
description: Lifecycle nurture sequence based on lead stage (5-phase — calendar → forms → tasks → gmail → bigquery) Trigger by asking for /mk:nurture or /mk-nurture.
---
...
Activate crm-specialist agent. Execute .agents/workflows/crm-workflow.md (5 phases). Idempotency required.
