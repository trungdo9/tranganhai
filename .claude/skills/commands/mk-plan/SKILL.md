---
name: mk-plan
description: Marketing plan — bootstrap or update plans/marketing-context.md (ICP, positioning, voice) Trigger by asking for /mk:plan or /mk-plan.
---
