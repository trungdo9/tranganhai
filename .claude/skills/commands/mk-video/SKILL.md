---
name: mk-video
description: AI video production (6-phase — script → voiceover → visuals → edit → render → distribute) Trigger by asking for /mk:video or /mk-video.
---
...
Activate video-producer agent. Execute .agents/workflows/video-workflow.md (6 phases).
