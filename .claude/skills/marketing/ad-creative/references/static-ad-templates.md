...
The tiers here cover **statics only**. For the full S–F map across *all* Meta creative formats — including the video/UGC/partnership formats that dominate the top of the ranking (partnership ads, VSLs, yapper ads, authority ads) — see [meta-creative-formats.md](meta-creative-formats.md), the format map. This library is the static slice of that larger picture.
