---
name: ads
description: Paid advertising — Google Ads, Meta Ads, LinkedIn Ads strategy, structure, bidding.
allowed-tools: Read, Write, Glob, Grep
---

# Ads

> Paid advertising — Google Ads, Meta Ads, LinkedIn Ads strategy, structure, bidding.
...
- `plans/marketing/<campaign>/ads.md` — analysis / audit / brief
