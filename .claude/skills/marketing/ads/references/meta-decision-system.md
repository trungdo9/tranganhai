...
Format-level guidance on *which* creator-fronted formats to run (founder content, authority, amateur-investigation, creator low-fi statics, etc.) is creative-side work — hand it to [[ad-creative]].
