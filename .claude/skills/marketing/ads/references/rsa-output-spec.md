...
## Regulated-industry compliance (worked example: pt-BR medical / CFM)

If `plans/marketing-context.md` flags a regulated vertical, apply its forbidden-words list before emitting any asset. Worked example — a Brazilian medical practice (CFM-regulated) forbids the following in headlines, descriptions, sitelinks, and callouts:
