---
name: analytics
description: Marketing analytics — GA4, GSC, attribution models, dashboards, KPI trees.
allowed-tools: Read, Write, Glob, Grep
---

# Analytics

> Marketing analytics — GA4, GSC, attribution models, dashboards, KPI trees.
...
- `plans/marketing/<campaign>/analytics.md` — analysis / audit / brief
