...
> Reference for the `analytics` skill. Pick the subset where each event maps to a real decision — do not implement the whole list. Never place PII in a property.
