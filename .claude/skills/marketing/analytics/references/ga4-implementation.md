...
> Reference for the `analytics` skill — instrumentation design (what to fire, how to configure). For *reading* GA4 data, use `skills/automation/mcp-ga4/SKILL.md` (MCP tools + CSV fallback) or the `seo-google` skill (direct GA4 Data API).

Source: `coreyhaines31/marketingskills` (MIT, © 2025 Corey Haines), adapted for ClauKit.
