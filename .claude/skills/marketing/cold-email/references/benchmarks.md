...
_Ported for ClauKit from `coreyhaines31/marketingskills` (MIT, © 2025 Corey Haines). Every figure here is as reported by the named vendor/source for 2024–2025 cold-outbound datasets — directional benchmarks, not independently verified, and not stable over time. Use them to choose between options, never to promise an outcome in copy._
