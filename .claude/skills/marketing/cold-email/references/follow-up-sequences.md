...
_Ported for ClauKit from `coreyhaines31/marketingskills` (MIT, © 2025 Corey Haines). Figures below are as reported by the cited vendor studies — directional, not independently verified. Cadence is a starting point; jurisdictional rules on unsolicited commercial email override it (see SKILL.md → Compliance)._
