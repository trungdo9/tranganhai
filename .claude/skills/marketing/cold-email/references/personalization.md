...
_Ported for ClauKit from `coreyhaines31/marketingskills` (MIT, © 2025 Corey Haines). Percentages below are as reported by the cited vendor studies — directional, not independently verified._
