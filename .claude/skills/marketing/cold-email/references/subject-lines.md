...
_Ported for ClauKit from `coreyhaines31/marketingskills` (MIT, © 2025 Corey Haines). Figures below are as reported by the cited vendor studies (Lavender, Belkins, Gong) — directional, not independently verified, and they conflict in places; where they conflict the resolution is stated._
