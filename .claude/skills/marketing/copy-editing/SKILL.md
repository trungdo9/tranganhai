---
name: copy-editing
description: Copy editing — clarity, concision, brand voice, grammar, conversion lift.
allowed-tools: Read, Write, Glob, Grep
---

# Copy Editing

> Copy editing — clarity, concision, brand voice, grammar, conversion lift.
...
- `plans/marketing/<campaign>/copy-editing.md` — analysis / audit / brief
