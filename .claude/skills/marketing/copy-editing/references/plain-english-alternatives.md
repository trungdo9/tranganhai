...
Swap table for the Quick-pass checks in `../SKILL.md`. Replace complex or pompous words with plain alternatives. Not a blind find-and-replace: keep the complex word when it is the precise term for the ICP (a legal, medical, or engineering audience often needs it) or when `plans/marketing-context.md` names it as house terminology.

Sources: Plain English Campaign A-Z of Alternative Words (2001), Australian Government Style Manual (2024), plainlanguage.gov.
