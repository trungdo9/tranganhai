---
name: paywalls
description: Paywall design — pricing pages, upgrade flows, feature gates, conversion paths.
allowed-tools: Read, Write, Glob, Grep
---

# Paywalls

> Paywall design — pricing pages, upgrade flows, feature gates, conversion paths.
...
- `plans/marketing/<campaign>/paywalls.md` — analysis / audit / brief
