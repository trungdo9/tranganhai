---
name: seo-audit
description: Full-site SEO audit — 7-phase pipeline with falsifiable findings.
allowed-tools: Read, Write, Glob, Grep
---

# Seo Audit

> Full-site SEO audit — 7-phase pipeline with falsifiable findings.
...
- `plans/marketing/<campaign>/seo-audit.md` — analysis / audit / brief
