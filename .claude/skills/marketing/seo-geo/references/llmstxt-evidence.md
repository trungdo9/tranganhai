...
one anyway as low-cost optionality for non-Google AI services, but never
present it as a Google ranking or citation lever in a `seo-geo` report.
...
## How this skill treats `llms.txt`
...
- If the user asks to generate one, this skill produces a minimal valid
...
Update this file (and the `seo-geo` SKILL.md copy) when:
