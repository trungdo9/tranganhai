...
---
*URL Inspection API: 2,000 inspections/day per site, 600/min. No native batch endpoint — one call per URL.*
*Generated {timestamp} via the Google Search Console URL Inspection API (see `references/search-console-api.md`).*
