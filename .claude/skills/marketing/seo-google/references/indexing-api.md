...
6. Before submitting: confirm the target page actually carries JobPosting or BroadcastEvent/VideoObject structured data (see [[seo-schema]]) — otherwise this API is the wrong tool regardless of quota headroom.
