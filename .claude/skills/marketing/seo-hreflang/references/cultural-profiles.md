...
| Trust Signals | TÜV, ISO certifications, "Datenschutz" (privacy), Impressum required by law. |
...
| CTA Style | Elegant phrasing. "Découvrir nos solutions" over "Achetez maintenant". |
| Trust Signals | "Fabriqué en France" (made in France), professional certifications, press mentions. |
| Legal | Mentions légales required. CNIL (data protection). CGV (terms). |
...
| Legal | LOPD (Spain data protection). Each LATAM country has its own regulations. |
...
| CTA Style | Subtle and polite. "お問い合わせ" (inquire) over a direct "buy now". |
...
7. **Research color meanings** — colors carry different cultural associations globally.

## How to use in analysis

When running `/mk:seo hreflang` on a multi-language site:
