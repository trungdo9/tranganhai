---
name: seo-image-gen
description: Image generation for SEO — AI image prompts, alt-text optimization, visual content.
allowed-tools: Read, Write, Glob, Grep
---

# Seo Image Gen

> Image generation for SEO — AI image prompts, alt-text optimization, visual content.
...
- `plans/marketing/<campaign>/seo-image-gen.md` — analysis / audit / brief
