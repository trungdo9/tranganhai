---
name: seo-local
description: Local SEO — Google Business Profile, NAP consistency, local pack ranking.
allowed-tools: Read, Write, Glob, Grep
---

# Seo Local

> Local SEO — Google Business Profile, NAP consistency, local pack ranking.
...
- `plans/marketing/<campaign>/seo-local.md` — analysis / audit / brief
