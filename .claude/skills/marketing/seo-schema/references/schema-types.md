...
> - **Adding new FAQPage**: No Google SERP benefit; do not recommend it for Google SERP benefit. Emit it only when the article genuinely has a Q&A section — it documents the content, it doesn't earn a rich result.
...
E-commerce-specific Product/Offer/variant depth (returns, shipping, loyalty pricing, adult-consideration flag) lives in [[seo-ecommerce]] — this skill emits the base template, that skill owns the vertical-specific rules.
...
5. No placeholder text (e.g., "[Business Name]") — every bracket must be filled before shipping
