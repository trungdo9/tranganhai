---
name: seo-sxo
description: Search Experience Optimization — blend SEO + UX + CRO for ranking pages that convert.
allowed-tools: Read, Write, Glob, Grep
---

# Seo Sxo

> Search Experience Optimization — blend SEO + UX + CRO for ranking pages that convert.
...
- `plans/marketing/<campaign>/seo-sxo.md` — analysis / audit / brief
