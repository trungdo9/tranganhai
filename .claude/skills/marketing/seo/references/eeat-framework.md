...
## Authoritativeness (scoring weight: 25%)
...
## Trustworthiness (scoring weight: 30%)
...
**Why:** AI can generate expertise-sounding content but cannot fabricate genuine experience — this is the same constraint [[seo-content]]'s truth-only rule enforces when drafting new articles.
...
See [[seo-content]] for the section-by-section writing method that targets this rubric directly, and [[seo-content-brief]] for baking E-E-A-T requirements into the outline before writing starts.
