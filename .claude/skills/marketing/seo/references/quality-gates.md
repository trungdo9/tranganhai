...
### Why This Matters
Google's doorway-page classifiers penalize programmatic location pages with thin/duplicate content. Signs of doorway pages:
...
See [[seo-programmatic]] for the full programmatic-SEO planning workflow this
gate feeds into.
...
See [[seo-images]] for the full image-SEO audit and optimization workflow.
...
See [[seo-cluster]] for the hub-and-spoke internal-link graph this table feeds.
