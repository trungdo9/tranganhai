---
name: signup
description: Signup flow optimization — friction reduction, social proof, form design.
allowed-tools: Read, Write, Glob, Grep
---

# Signup

> Signup flow optimization — friction reduction, social proof, form design.
...
- `plans/marketing/<campaign>/signup.md` — analysis / audit / brief
