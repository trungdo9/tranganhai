---
name: social-content
description: Social content — platform-native posts, hooks, threads, repurposing system.
allowed-tools: Read, Write, Glob, Grep
---

# Social Content

> Social content — platform-native posts, hooks, threads, repurposing system.
...
- `plans/marketing/<campaign>/social-content.md` — analysis / audit / brief
