...
Instead of guessing what works, systematically analyze top-performing content in the niche and extract the patterns.

Analysis is language and structure research, never copying: take the hook shapes, formats, and vocabulary — never a creator's specific post, claim, or asset. Any number that ends up in your own copy must be yours and real.

Scale collection needs Bash/WebFetch, which this skill does not hold — run it through the calling agent (`content-strategist`, `copywriter`) or hand the recipes to the user. Third-party scrapers below are named as options, not ClauKit-wired tooling.
...
**Specific > Vague**
```
Weak:   "I made good revenue"
Better: "I made $47,329"

Weak:   "It took a while"
Better: "It took 47 days"
