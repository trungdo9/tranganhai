...
Comprehensive list of A/B tests and experiments for user onboarding and activation. One variable per test (see [[cro]] principle 16). Never report a projected lift as a measured one.
...
Email-side tests are designed here but specified and written by [[email-sequence]] — this skill supplies the in-product trigger and the step being reinforced.
